...
export function Home() {
  ...
  return (
    <div ref={ref} className="w-full h-[300vh]  overflow-hidden bg-black">
      ...
      <Layer speed={1} image={middle} zIndex={5} />
      <Layerfront speed={3} image={background} zIndex={6} />

      {/* <div className="absolute inset-0  flex items-center justify-center"> */}
      <motion.div
        className="flex items-center justify-center absolute font-bold text-white text-7xl md:text-9xl z-5 h-screen w-full"
